...
icon: "triangle"
"og:type": "article"
"og:title": "Integrate Bugster with Vercel - Automated Preview Testing"
"og:description": "Integrate Bugster with Vercel to run tests on preview deployments, fail PRs on regressions, and automate quality checks with protection bypass configuration."
"og:url": "https://docs.bugster.dev/integrations/vercel"
