...
icon: "cubes"
"og:type": "article"
"og:title": "Custom Bugster Integration - Webhook API"
"og:description": "Build custom Bugster integrations with webhook API. Trigger tests from any deployment platform with full control over environments and execution timing."
"og:url": "https://docs.bugster.dev/integrations/custom"
---
