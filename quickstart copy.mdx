...
<Steps>
  <Step title="Access GitHub Integration">
    Visit the [Bugster Dashboard](https://app.bugster.dev) and navigate to GitHub integration settings and click `"Connect Organization"` .
  </Step>
...
<Info>
  **Need help?** Visit our [documentation](https://docs.bugster.dev) or reach out to our support team through the [Bugster Dashboard](https://app.bugster.dev).
</Info>