...
<Step title="Quick validation">
  ...
  bugster run --quick "Test the new checkout validation"
  ```
</Step>
...
bugster run --quick/prompt "Test this component I just built"

# Test specific functionality
bugster run --quick/prompt "Check if the search works with empty results"
```
