...
icon: "upload"
"og:type": "article"
"og:title": "Bugster File Upload Testing - Test File Uploads in YAML"
"og:description": "Test file uploads in Bugster with centralized File Management. Support for documents, images, and multiple file uploads with automated test execution."
"og:url": "https://docs.bugster.dev/guides/test-management/file-upload"
---

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/beVr0flvCo4"
  title="File Upload Testing with Bugster"
  frameBorder="0"
