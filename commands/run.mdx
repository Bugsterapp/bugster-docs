...
icon: "play"
"og:type": "article"
"og:title": "bugster run - Execute Automated Tests"
"og:description": "Run automated browser tests with bugster run. Parallel execution, headless mode, affected tests only, and real-time streaming to dashboard."
"og:url": "https://docs.bugster.dev/commands/run"
---
