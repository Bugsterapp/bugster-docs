...
icon: 'fingerprint'
"og:type": "article"
"og:title": "bugster init - Initialize Project Configuration"
"og:description": "Set up Bugster in your repository with bugster init. Configure credentials, application URLs, and project settings for automated testing."
"og:url": "https://docs.bugster.dev/commands/init"
---
