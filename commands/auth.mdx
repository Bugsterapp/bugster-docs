...
<Steps>
  ...
  <Step title="Retrieve API Key">
    <Card title="Get Your API Key" icon="key" href="https://app.bugster.dev">
...
<Info>
  **Need a new API key?** Visit the [Bugster Dashboard](https://app.bugster.dev) to generate or manage your API keys.
</Info>

<Warning>
  **Lost access?** If you can't access your dashboard or need to reset your account, contact support through the [Bugster Dashboard](https://app.bugster.dev).
</Warning>