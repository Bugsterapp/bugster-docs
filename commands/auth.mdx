...
icon: 'lock'
"og:type": "article"
"og:title": "bugster auth - Manage API Authentication"
"og:description": "Configure Bugster API key authentication with bugster auth. Secure storage, environment variables, and team credential management."
"og:url": "https://docs.bugster.dev/commands/auth"
---
