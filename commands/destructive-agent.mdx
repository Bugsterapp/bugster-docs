...
icon: "bomb"
"og:type": "article"
"og:title": "bugster destructive - AI-Powered Bug Discovery"
"og:description": "Discover edge case bugs with bugster destructive. AI agents simulate malicious users, stress-test forms, and find vulnerabilities in staging environments."
"og:url": "https://docs.bugster.dev/commands/destructive-agent"
