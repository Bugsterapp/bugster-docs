  ...
  <Accordion title="System Requirements" icon="computer" defaultClosed>
    <CardGroup cols={2}>
      <Card title="Python 3.10+" icon="python">
        Required for CLI core functionality
      </Card>
...
# https://github.com/Bugsterapp/bugster-cli/releases/latest/download/install.bat
```
...
<AccordionGroup>
  ...
  <Accordion title="Permission errors (macOS/Linux)">
    Try running the installation with sudo if you encounter permission issues.
  </Accordion>
</AccordionGroup>

<Info>
  **What gets installed**: Bugster CLI, Playwright browsers, and all required dependencies are installed automatically.
</Info>
